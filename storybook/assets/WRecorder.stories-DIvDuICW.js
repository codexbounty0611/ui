import{S as i,af as f}from"./vue.esm-bundler-DdplDy38.js";import{v as y}from"./vExtractRootEl-DETW6UcW.js";import{s as p,q as v,p as b}from"./index-TFupZtJ7.js";import"./WRoot-Dr78YGtX.js";import"./iframe-1hv05qNq.js";import"./twMerge-CLwyhV7-.js";const m=(r,o,t,a)=>({keydown(e){if(e.preventDefault(),!p(e)&&e.key==="Escape"){r.value=t.value,o.value=!1;return}if(!p(e)&&e.key==="Enter"){o.value=!1;return}r.value+=` ${e.key}`},mousedown(e){const l=e.target,u=a.value;l===u||u?.contains(l)||(r.value+=` ${e.button}`,e.preventDefault())},wheel(e){r.value+=` ${e.deltaY>0?"↓":"↑"}`,e.preventDefault()}}),g=(r,o,t,a)=>()=>{o.value||(r.value&&(a?.value?(a.value.push(r.value),t.value=""):t.value=r.value),r.value="")};m.__docgenInfo={exportName:"createRecorderHandler",displayName:"createRecorderHandler",type:2,props:[{name:"value",global:!1,description:"",tags:[],required:!0,type:"string",declarations:[],schema:"string"},{name:"__@RefSymbol@3139",global:!1,description:`Type differentiator only.
We need this to be in public d.ts but don't want it to show up in IDE
autocomplete, so we use a private Symbol instead.`,tags:[],required:!0,type:"true",declarations:[],schema:"true"}],events:[],slots:[],exposed:[],sourceFiles:"/home/runner/work/ui/ui/src/runtime/helpers/storybook.ts"};g.__docgenInfo={exportName:"createRecorderWatchEffect",displayName:"createRecorderWatchEffect",type:2,props:[{name:"value",global:!1,description:"",tags:[],required:!0,type:"string",declarations:[],schema:"string"},{name:"__@RefSymbol@3139",global:!1,description:`Type differentiator only.
We need this to be in public d.ts but don't want it to show up in IDE
