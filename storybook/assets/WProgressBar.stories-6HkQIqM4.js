import{S as i,M as m}from"./vue.esm-bundler-DdplDy38.js";import{i as p}from"./WRoot-Dr78YGtX.js";import{q as d}from"./index-TFupZtJ7.js";import"./iframe-1hv05qNq.js";import"./twMerge-CLwyhV7-.js";const S={component:p,title:"Components/ProgressBar",args:{label:"Label",_timeout:1e3,_add:10,_start:50}},e={render:s=>{const l=s;return{components:d,setup:()=>{const g=i(!1),r=i(l._start);if(s.progress)r.value=s.progress;else{let c=!1;const u=setInterval(()=>{c||(r.value>=100?(c=!0,setTimeout(()=>{r.value=0,c=!1},2e3)):r.value+=l._add)},l._timeout);m(()=>{clearInterval(u)})}return{args:{...s},forceFull:g,progress:r}},template:`
...
}`,...o.parameters?.docs?.source}}};const x=["Primary","ReallyLongLabel","Static","AutoHiding","AutoHidingNoKeepSpace"];export{n as AutoHiding,o as AutoHidingNoKeepSpace,e as Primary,a as ReallyLongLabel,t as Static,x as __namedExportsOrder,S as default};
