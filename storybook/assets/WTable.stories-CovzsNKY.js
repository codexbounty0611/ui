import{f as n}from"./chunk-NAVWDHVN-4xFUB_is.js";import{Q as I,S as y}from"./vue.esm-bundler-DdplDy38.js";import{q as v,m as W}from"./index-TFupZtJ7.js";import"./WRoot-Dr78YGtX.js";import"./iframe-1hv05qNq.js";import"./twMerge-CLwyhV7-.js";const P=Array.from({length:100}).fill(0).map(a=>n.lorem.sentence(n.number.int({min:1,max:50}))),$={component:W,title:"Components/Table"},e={render:a=>({components:v,setup:()=>{const x=y(!0),_=y(!1);return{args:I({...a,resizable:{enabled:!0,...a.resizable}}),debugGrips:_,show:x}},template:`
        ...
        `,wrapperAttrs:{class:"max-h-[50dvh]"},values:Array.from({length:1e4}).fill(0).map((a,r)=>({prop1:`Item${r+1} Prop 1`,prop2:`Item${r+1} Prop 2`,prop3:`Item${r+1} Prop 3`}))}},o={render:a=>({components:v,setup:()=>{const r=y(!1);return{args:a,debugGrips:r}},template:`
